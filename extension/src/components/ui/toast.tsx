...
type ToastPortalProps = React.ComponentProps<typeof Toast.Portal>;
...
function Toasts({
  ...
  return (
    <Toast.Portal {...portalProps} data-slot="toast-portal">
      <Toast.Viewport
        className={cn(
...
export function ToastProvider({
  ...
  return (
    <Toast.Provider toastManager={toastManager} {...props}>
      {children}
      <Toasts position={position} portalProps={portalProps} />
    </Toast.Provider>
  );
}
