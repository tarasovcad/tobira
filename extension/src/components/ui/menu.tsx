  ...
  return (
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          className={cn(
            "bg-popover relative flex origin-(--transform-origin) rounded-lg border font-sans shadow-lg/5 outline-none not-dark:bg-clip-padding not-[class*='w-']:min-w-32 before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/6%)] focus:outline-none dark:before:shadow-[0_-1px_--theme(--color-white/6%)]",
            className,
          )}
  ...
  return (
    ...
    >
      ...
      <span className="ml-auto">
        <ChevronRightIcon className="-mr-0.5 size-4 opacity-80" />
      </span>
    </MenuPrimitive.SubmenuTrigger>
  );
}
