const IMPORTED_ITEMS = ["Bookmarks", "Posts with media", "Outbound links"];
...
function XPermissionShieldIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
...
export function XAboutStep() {
  return (
    <>
      ...
      <div className="px-6">
        <div className="border-border bg-muted/45 text-secondary rounded-lg border px-3.5 py-3 text-sm leading-relaxed">
          Tobira does not store your credentials. We use read-only API access and you can disconnect
          at any time.
        </div>
      </div>
    </>
