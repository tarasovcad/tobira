...
export function PreviewToolbar({
  ...
  return (
    <div
      className={`absolute top-5 right-5 z-10 flex items-center overflow-hidden rounded-md border border-white/10 bg-black/40 shadow-xl backdrop-blur-md transition-opacity duration-[180ms] ${
